        ...
        <div suppressHydrationWarning style={{ position: "relative", zIndex: 1, minHeight: "100vh", display: "flex", flexDirection: "column" }}>
          ...
          <footer className="w-full flex items-center justify-center py-8 mt-auto font-mono text-[var(--text-muted)] text-[0.85rem] tracking-[0.1em]">
            <div className="flex flex-wrap justify-center gap-6 items-center" style={{ fontSize: "0.9rem" }}>
              ...
              <a href="https://chat.whatsapp.com/EaFgsyEUwSRD70ueBtZyH1?mode=gi_t" target="_blank" rel="noopener noreferrer" className="hover:text-white hover:drop-shadow-[0_0_10px_currentColor] hover:scale-110 transition-all duration-300 transform" style={{ textDecoration: "none", color: "#25D366" }} aria-label="WhatsApp">
              ...
              <div className="relative group flex items-center justify-center cursor-pointer">
                <a href="https://www.instagram.com/satyagupta.dev/" target="_blank" rel="noopener noreferrer" className="hover:text-white hover:drop-shadow-[0_0_10px_currentColor] hover:scale-110 transition-all duration-300 transform" style={{ color: "#E1306C", textDecoration: "none" }}>

        ...
        <div style={{ position: "relative", zIndex: 1, minHeight: "100vh", display: "flex", flexDirection: "column" }}>
          ...
          <footer style={{
            ...
            <div className="flex flex-wrap justify-center gap-6 mt-1 items-center" style={{ fontSize: "0.9rem" }}>
              ...
              <a href="https://chat.whatsapp.com/EaFgsyEUwSRD70ueBtZyH1?mode=gi_t" target="_blank" rel="noopener noreferrer" className="hover:text-white transition-colors" style={{ textDecoration: "none", color: "inherit" }} aria-label="WhatsApp">
              ...
              <a href="https://discord.gg/gQEP4TyFh" target="_blank" rel="noopener noreferrer" className="hover:text-white transition-colors" style={{ textDecoration: "none", color: "inherit" }} aria-label="Discord">

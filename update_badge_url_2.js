...
if (fs.existsSync(jsonPath)) {
  ...
  for (let i = 0; i < existingBadges.length; i++) {
    if (existingBadges[i].title === "Google Cloud Database Migrations: Homogeneous") {
      existingBadges[i].path = "/course_templates/1637";
      updated = true;
      break;
    }
  }
  ...
  if (updated) {
    ...
    console.log("Successfully updated the URL for 'Google Cloud Database Migrations: Homogeneous'");
  } else {
